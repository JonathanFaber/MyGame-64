...
void createShaders(){
	...
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "VS", "vs_5_0", 0, 0, 0, &VS_Buffer, 0, 0);		//Used to be vs_4_0 and ps_4_0
	...
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "SPRITE_VS", "vs_5_0", 0, 0, 0, &SPRITE_VS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "SPRITE_PS", "ps_5_0", 0, 0, 0, &SPRITE_PS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "PLANET_VS", "vs_5_0", 0, 0, 0, &PLANET_VS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "PLANET_PS", "ps_5_0", 0, 0, 0, &PLANET_PS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "INSTANCE_VS", "vs_5_0", 0, 0, 0, &INSTANCE_VS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Effects.fx", 0, 0, "INSTANCE_PS", "ps_5_0", 0, 0, 0, &INSTANCE_PS_Buffer, 0, 0);
